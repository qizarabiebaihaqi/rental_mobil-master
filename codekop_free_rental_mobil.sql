...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2361076804ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="224">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=codekop_free_rental_mobil&table=booking">`codekop_free_rental_mobil`.`booking`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=codekop_free_rental_mobil&table=pembayaran">`codekop_free_rental_mobil`.`pembayaran`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=codekop_free_rental_mobil&table=login">`codekop_free_rental_mobil`.`login`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_spare&table=tb_admin">`db_spare`.`tb_admin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_spare&table=tb_contact">`db_spare`.`tb_contact`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=perpustakaan&table=pengarang">`perpustakaan`.`pengarang`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=perpustakaan&table=buku">`perpustakaan`.`buku`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_spare&table=catalog">`db_spare`.`catalog`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_spare&table=tb_produk">`db_spare`.`tb_produk`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_spare&table=tb_penjualan">`db_spare`.`tb_penjualan`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="504937403c454d73446d7e414c62265a">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="224"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
