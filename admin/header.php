...
<html lang="en">
  <head>
    <title><?php echo $title_web;?> | tiketux</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  <body>
    <div class="jumbotron pt-4 pb-4" style="background-color: #76b9fc;">
        <div class="row">
            <div class="col-sm-8">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #76b9fc;">
